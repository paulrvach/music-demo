...
import type { SongType } from '@/app/home/_components/song-data';
...
const playlistsSlice = createSlice({
  ...
  reducers: {
    ...
    setSongInFocus: (state, action: PayloadAction<SongType>) => {
      state.songInFocus = action.payload;
    },
  },
});

// Export actions and reducer
export const { setPlaylists, setSongInFocus } = playlistsSlice.actions;
